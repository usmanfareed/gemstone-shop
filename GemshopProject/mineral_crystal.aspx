<%@ Page Title="mineral_crystal" Language="C#" MasterPageFile="~/Index.master" AutoEventWireup="true" CodeFile="mineral_crystal.aspx.cs" Inherits="mineral_crystal" %>

<asp:Content ID="mineral_crystal" ContentPlaceHolderID="IndexBody" Runat="Server">

        
      <div class="breadcrumbs">
        <div class="container_12">
            <div class="grid_12">
                 <a href="Home.aspx">Home</a><span></span><span class="current">MINERAL AND CRYSTAL</span>
            </div><!-- .grid_12 -->
        </div><!-- .container_12 -->
    </div><!-- .breadcrumbs -->
    ...
    <section id="main">
        <div class="container_12">
            <div id="content" class="grid_9">
                <h1 class="page_title">MINERAL AND CRYSTAL</h1>
