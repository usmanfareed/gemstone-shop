<%@ Page Title="roughGemstones" Language="C#" MasterPageFile="~/Index.master" AutoEventWireup="true" CodeFile="roughGemstones.aspx.cs" Inherits="roughGemstones" %>

<asp:Content ID="roughGemstones" ContentPlaceHolderID="IndexBody" Runat="Server">

    
      <div class="breadcrumbs">
        <div class="container_12">
            <div class="grid_12">
                 <a href="Home.aspx">Home</a><span></span><span class="current">ROUGH GEMSTONES</span>
            </div><!-- .grid_12 -->
        </div><!-- .container_12 -->
    </div><!-- .breadcrumbs -->
    ...
    <section id="main">
        <div class="container_12">
            <div id="content" class="grid_9">
                <h1 class="page_title">ROUGH GEMSTONES</h1>
